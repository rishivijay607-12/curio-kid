...
const generateDiagramImage = async (ai: GoogleGenAI, { prompt }: any): Promise<string> => {
    // Add style and safety guardrails to the prompt generated by the text model.
    const augmentedPrompt = `${prompt}. Style: clear and colorful educational illustration for a science textbook. IMPORTANT: Do not include any people or human figures.`;
