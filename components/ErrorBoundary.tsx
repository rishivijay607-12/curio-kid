...
class ErrorBoundary extends React.Component<Props, State> {
  // Fix: All errors stemmed from the TypeScript compiler failing to recognize 'this.state' and 'this.props'.
  // Initializing state as a public class field is a more modern approach and resolves these parsing issues.
  public state: State = { 
    hasError: false,
    error: undefined,
  };
