...
const features = [
    ...
    { mode: 'educational_video' as AppMode, title: 'Educational Video', description: 'Generate a short animated video explaining any science topic.', icon: <IconVideo /> },
