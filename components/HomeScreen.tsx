...
const IconMultiplayer: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75c0 3.142-2.56 5.7-5.7 5.7s-5.7-2.558-5.7-5.7c0-3.142 2.56-5.7 5.7-5.7s5.7 2.558 5.7 5.7zM12 21.75a9 9 0 006.75-3.033M12 21.75a9 9 0 01-6.75-3.033" /></svg>;
...
const features = [
    ...
    { mode: 'multiplayer_quiz' as AppMode, title: 'Study Group Showdown', description: 'Challenge your friends in a real-time multiplayer quiz!', icon: <IconMultiplayer /> },
