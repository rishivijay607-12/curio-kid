...
const IconWorksheet: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M17 16v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-7a2 2 0 012-2h2m3-4H9a2 2 0 00-2 2v7a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-1m-1 4l-3 3m0 0l-3-3m3 3V3" /></svg>;
...
const IconMobile: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>;
        ...
        <p className="text-slate-300 mt-3 text-lg">
         ...
         <div className="mt-6 flex justify-center items-center gap-4 flex-wrap">
             ...
             {/* 
                ...
                * This links to an Android APK file hosted on Google Drive.
                * IMPORTANT: Replace 'YOUR_FILE_ID_HERE' with your actual Google Drive file ID.
                * The link format for a direct download is:
                * https://drive.google.com/uc?export=download&id=YOUR_FILE_ID_HERE
             */}
             <a 
                href="https://drive.google.com/uc?export=download&id=https://drive.google.com/uc?export=download&id=13UZysSXuUOg6bMnu77y4fYcbdFtR8nB1
" 
                download
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center px-5 py-2.5 bg-slate-800 text-slate-200 font-semibold rounded-full hover:bg-slate-700 transition-colors shadow"
