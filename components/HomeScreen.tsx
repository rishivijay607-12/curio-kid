...
const features = [
    ...
    { mode: 'community_chat' as AppMode, title: 'Community Chat', description: 'Chat with other students in a safe, moderated environment.', icon: <IconCommunityChat /> },
